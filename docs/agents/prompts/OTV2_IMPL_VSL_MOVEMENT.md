...
Write only exact paths allocated to `OTV2-IMPL-MOVE` by the live implementation coordinator in `blakinio/Oteryn-v2`. No active allocation means read-only discovery.
